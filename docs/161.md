...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse5f40c7" aria-expanded="false" aria-controls="collapse5f40c7" markdown="1">解为最小目标差 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse0911ed" aria-expanded="false" aria-controls="collapse0911ed" markdown="1">解为最高平均温度 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsee29ee7" aria-expanded="false" aria-controls="collapsee29ee7" markdown="1">解重构 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapseef5a94" aria-expanded="false" aria-controls="collapseef5a94" markdown="1">解为最小目标差使用熊猫 显示/隐藏</button>
