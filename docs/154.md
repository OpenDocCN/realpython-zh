...
[![Index page of the Fake Python job board](../Images/0a194e764196106ec6224fa654a2e2f0.png)](https://files.realpython.com/media/bs4-fake-python-index.b76716592442.png)
...
![Search interface of the Indeed job board](../Images/10ff380e917db6dddb88f07378948193.png)
...
[![Chrome developer tools open showing the HTML of a Fake Python job board card](../Images/2f63fe4bc63d6367f1919f2356fecd36.png)](https://files.realpython.com/media/bs4-devtools.f0a236ca5fa3.png)
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapseb998a6" aria-expanded="false" aria-controls="collapseb998a6" markdown="1">练习:探索 HTML 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsea60af4" aria-expanded="false" aria-controls="collapsea60af4" markdown="1">练习:提炼你的结果 显示/隐藏</button>

每个工作卡都有两个关联的链接。您只需要寻找第*个第二*个链接。如何编辑上面显示的代码片段，以便总是只收集第二个链接的 URL？

单击解决方案模块，阅读本练习的可能解决方案:

<button class="btn w-100" data-toggle="collapse" data-target="#collapse194719" aria-expanded="false" aria-controls="collapse194719" markdown="1">解决方案:提炼你的结果 显示/隐藏</button>
