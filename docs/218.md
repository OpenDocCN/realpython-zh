...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse4aa873" aria-expanded="false" aria-controls="collapse4aa873" markdown="1">用按位运算符 计算布尔表达式显示/隐藏</button>
...
[![Animation depicting the bitwise AND operator](../Images/df54d91b0ff2389bed5abd5514562275.png)](https://files.realpython.com/media/and.ef7704d02d6f.gif)

产生的位模式是运算符参数的**交集**。在两个操作数都为 1 的位置上，它有两个打开的位。在所有其他地方，至少有一个输入为 0 位。

从算术上讲，这相当于两个位值的**乘积**。你可以计算数字 *a* 和 *b* 的位与，方法是在每个索引 *i* 处乘以它们的位:

[![The arithmetic formula for the bitwise AND operator](../Images/cdb3579013ff4c75ac441f05f1e6f1f4.png)](https://files.realpython.com/media/and.8577ec486e95.png)
...
[![Animation depicting the bitwise OR operator](../Images/56d5b8c5777b2d8a08d77755fe7862d1.png)](https://files.realpython.com/media/or.7f09664e2d15.gif)
...
[![The arithmetic formula for the bitwise OR operator](../Images/af1109a07b879c504512049a2aa868ec.png)](https://files.realpython.com/media/or.13c36c59de27.png)
...
[![Animation depicting the bitwise XOR operator](../Images/535f95e8d065d81d953befa2572f218d.png)](https://files.realpython.com/media/xor.8c17776dd501.gif)
...
[![The arithmetic formula for the bitwise XOR operator](../Images/0c229823583839612993714d86f816f5.png)](https://files.realpython.com/media/xor.1303ef1b5fb2.png)
...
[![Animation depicting the bitwise NOT operator](../Images/8abbb982b76a53939b7bddc8c24114cc.png)](https://files.realpython.com/media/not.7edac5691829.gif)

反转的位是对 1 的补码，将 0 变成 1，将 1 变成 0。它可以用算术方法表示为从 1 中减去单个比特值的**减法**:

[![The arithmetic formula for the bitwise NOT operator](../Images/8f06d933232e5be84402e28204f50932.png)](https://files.realpython.com/media/not.1773bca4c9ab.png)
...
[![Animation depicting the left shift operator](../Images/eaba8ffaac816b2c6dd0158f2a3ed9f8.png)](https://files.realpython.com/media/lshift.e06f1509d89f.gif)
...
[![The arithmetic formula for the left shift operator](../Images/f7af3997d54ab0119a0e281bc57f3829.png)](https://files.realpython.com/media/lshift.2b65aa74eb55.png)
...
[![Animation depicting the left shift operator with a bitmask](../Images/d7252781031e245b662b94ec1098e730.png)](https://files.realpython.com/media/lshift_masked.b627c10fcebb.gif)
...
[![Animation depicting the right shift operator](../Images/8b7f758f8005f440ab9d70b93ca1af90.png)](https://files.realpython.com/media/rshift.9d585c1c838e.gif)
...
[![The arithmetic formula for the right shift operator](../Images/9d37f085537acf2019531b681979a1a6.png)](https://files.realpython.com/media/rshift.093b1368dd1f.png)
...
[![Animation depicting the right shift operator with a bitmask](../Images/68dcd266ebe2d161bd5f97b7233bc3d8.png)](https://files.realpython.com/media/rshift_masked.fa8db8eea0cd.gif)
...
[![Animation depicting the logical right shift operator](../Images/815a3cbe2911679b9bc59c667a5b4400.png)](https://files.realpython.com/media/rshift_logical.5ee25943b1a4.gif)
...
[![Animation depicting the arithmetic right shift operator](../Images/66bd237bce4d86fcccfe5e64bc16c426.png)](https://files.realpython.com/media/rshift_arithmetic.990b7e40923a.gif)
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsec9f428" aria-expanded="false" aria-controls="collapsec9f428" markdown="1">显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse4cd344" aria-expanded="false" aria-controls="collapse4cd344" markdown="1">显示/隐藏</button>
...
[![The Formula for Floating-Point Binary to Decimal Conversion](../Images/b459d2858dbfc8bce5726a4fc79d9b06.png)](https://files.realpython.com/media/fp-formula.5a1630e259a2.png)

当您用变量代替上面示例中的实际值时，您将能够破译以单精度存储的浮点数的位模式:

[![The Number Pi in Floating-Point Binary](../Images/7ae7b579e57af53cd7a7704fab6ecf72.png)](https://files.realpython.com/media/pi-formula.391a15af5088.png)
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse6a4466" aria-expanded="false" aria-controls="collapse6a4466" markdown="1">`int`和`long`在 Python 2 中 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse2bf7ff" aria-expanded="false" aria-controls="collapse2bf7ff" markdown="1">`int()`的其他用途显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapseb5f12b" aria-expanded="false" aria-controls="collapseb5f12b" markdown="1">检查 C 中的字节顺序T3】显示/隐藏 T5】</button>
...
[![Original Bitmap vs Altered Bitmap With Secret Data](../Images/46ac7255ed4c8283e158ebee1a9fcf91.png)](https://files.realpython.com/media/bird_eyes.d044f56893f6.png)
