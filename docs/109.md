...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsea21600" aria-expanded="false" aria-controls="collapsea21600" markdown="1">完整项目实施步骤 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse94cef7" aria-expanded="false" aria-controls="collapse94cef7" markdown="1">d witter/templates/d witter/profile . html显示/隐藏</button>
...
<div class="column">
 ...
 <div class="buttons has-addons"> <button class="button is-success">Follow</button> <button class="button is-danger">Unfollow</button> </div> </div>
...
[![Profile detail page showing both the Follow and Unfollow button as clickable](../Images/aa332ca14faedde55e7a38fca736c227.png)](https://files.realpython.com/media/ds-both-buttons.5c77bdeb4b2c.png)
...
[![Profile page showing the Follow button grayed out, because the current user already follows the profile](../Images/b805e0ba4b7082b7bf7980018e3d1bbf.png)](https://files.realpython.com/media/Screenshot_2021-08-17_at_10.46.40.2e7b685892a6.png)
...
[![ER diagram showing the relationship between the built-in User model and the Dweet model](../Images/5a91ff59d45ee2138e18af1654f7256b.png)](https://files.realpython.com/media/Database_ER_diagram_crows_foot.68598b0982d4.png)
...
[![Add a new Dweet through the Django admin interface](../Images/19a899fbd1f0e2bf9144b4c0df31eabc.png)](https://files.realpython.com/media/ds-admin-add-dweet.07a1e2a177ed.png)
...
[![Django admin page showing a successfully added "Dweet object"](../Images/1438322fecaf5171dc96f938abcca37c.png)](https://files.realpython.com/media/ds-admin-added-dweet-object.2101777114ad.png)
...
[![Django admin Dweet overview page showing an improved descriptive rendering of the Dweet object](../Images/72d72db499a67c4395e57eab4aabc60b.png)](https://files.realpython.com/media/ds-admin-descriptive-dweet.b00c3d1d48a5.png)
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsee2b755" aria-expanded="false" aria-controls="collapsee2b755" markdown="1">d witter/templates/d witter/profile . html显示/隐藏</button>
...
[![Profile page displaying all the user's dweets](../Images/670e982384f6195c3a794d6d8011775a.png)](https://files.realpython.com/media/Screenshot_2021-08-17_at_12.39.14.a08758ab142f.png)
...
[![Your dashboard view displaying all dweets of all profiles you follow](../Images/74353537ce45faedb693df1adba716bf.png)](https://files.realpython.com/media/ds-dashboard.977fcbb2bbe7.png)
