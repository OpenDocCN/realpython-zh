...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse872c63" aria-expanded="false" aria-controls="collapse872c63" markdown="1">练习:《自己试试:max split》显示/隐藏</button>

给一个负数作为`maxsplit`参数会怎么样？

<button class="btn w-100" data-toggle="collapse" data-target="#collapse737233" aria-expanded="false" aria-controls="collapse737233" markdown="1">解决方案:“自己试试:max split”显示/隐藏</button>

`.split()`将在所有可用的分隔符上分割字符串，这也是当`maxsplit`未设置时的默认行为。

<button class="btn w-100" data-toggle="collapse" data-target="#collapsebd6867" aria-expanded="false" aria-controls="collapsebd6867" markdown="1">练习:【章节理解检查】T3】显示/隐藏 T5】</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse05c757" aria-expanded="false" aria-controls="collapse05c757" markdown="1">解决方法: 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse5e96d8" aria-expanded="false" aria-controls="collapse5e96d8" markdown="1">练习:【加入可读性提升】 显示/隐藏</button>

如何使输出文本更具可读性？

<button class="btn w-100" data-toggle="collapse" data-target="#collapsee1cafe" aria-expanded="false" aria-controls="collapsee1cafe" markdown="1">解决方案:【可读性提升与加入】 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse80ba5d" aria-expanded="false" aria-controls="collapse80ba5d" markdown="1">练习:【章节理解检查】T3】显示/隐藏 T5】</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsed514f2" aria-expanded="false" aria-controls="collapsed514f2" markdown="1">解决方法: 显示/隐藏</button>
