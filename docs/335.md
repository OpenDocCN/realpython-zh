...
[![Blink example sketch on Arduino IDE](../Images/8c15ad4466a30c3fac710eb2104fe33f.png)](https://files.realpython.com/media/arduino_ide_open_blink.800adb25f6da.jpg)
...
[![Selecting board on Arduino IDE](../Images/1e91e833d5d17781011d911fdb2ef677.png)](https://files.realpython.com/media/arduino_ide_select_board.ab3e17d0f3e6.jpg)

选择板后，您必须设置适当的端口。再次进入*工具*菜单，这次选择*端口*:

[![Selecting port on Arduino IDE](../Images/423b3057823765bf5d7aae323e88c1b6.png)](https://files.realpython.com/media/arduino_ide_select_port.7eef188bba81.jpg)
...
[![Buttons for verify and upload on Arduino IDE](../Images/1ca37b586d99807e396d7de65a9df2de.png)](https://files.realpython.com/media/arduino_ide_buttons.fee61246ed0f.jpg)
...
[![Arduino buit-in LED blinking](../Images/b5059c3986fe1ad9af4a5b65ce56b377.png)](https://files.realpython.com/media/blinking.ad6c84c75f27.gif)
...
[![Arduino Uno Ports](../Images/2efd57bfebc879b7b7f9d5a614b86add.png)](https://files.realpython.com/media/arduino_ports.ccba6e743d26.png)
...
[![Circuit for blink sketch](../Images/8e8c8fa98983f4e12d7fa968b44ce950.png)](https://files.realpython.com/media/blink.18009615ed53.png)
...
[![Breadboard](../Images/c46aa8d324342927bc51d77ccb94b614.png)](https://files.realpython.com/media/breadboard.1429308d8fa9.jpg)
...
[![Circuit for blink sketch on breadboard](../Images/e00cb5c583eb6231ade75b04b63b1631.png)](https://files.realpython.com/media/blink_2.0a1b1975b7da.png)
...
[![Arduino built-in and external LEDs blinking](../Images/d81d72b88a4af80cf805236900e5d173.png)](https://files.realpython.com/media/blinking_2.ff9a0bc7491d.gif)
...
[![Firmata example sketch on Arduino IDE](../Images/490a114c630eb985d3753942788a09b6.png)](https://files.realpython.com/media/arduino_ide_firmata.35e3f089e6cd.jpg)
...
[![Circuit for digital input](../Images/a854f966e1c8790d7bb2b0bdf7044fda.png)](https://files.realpython.com/media/digital_input.5691a8f1d4fe.png)
...
[![Circuit for digital input on breadboard](../Images/b06189409b52f5538bc6ae9357d77a43.png)](https://files.realpython.com/media/digital_input_2.a46059238b65.png)
...
[![Circuit for analog input](../Images/e2e67798e7bdb9ab9ebc0dc3f5019990.png)](https://files.realpython.com/media/analog_input.b5c94511d649.png)

在这个电路中，LED 的设置和以前一样。电位计的终端连接到地(GND)和 5V 引脚。通过这种方式，中央终端(光标)可以具有 0V 至 5V 范围内的任何电压，具体取决于它的位置，它连接到模拟引脚 A0 上的 Arduino。

使用试验板，可以按如下方式组装该电路:

[![Circuit for analog input on breadboard](../Images/eeafe000562167591528aa8ffce1465d.png)](https://files.realpython.com/media/analog_input_2.1d0464a94dd5.png)
...
[![Led controlled by an analog input](../Images/7ca6b77f7922e17abce6187909751a19.png)](https://files.realpython.com/media/analog_input_demo.8a1831c1c606.gif)
...
[![Arduino Uno PWM ports](../Images/eeb90d85b739366996829156027da266.png)](https://files.realpython.com/media/arduino_pwm.e5057a13e704.png)
...
[![Circuit for analog output](../Images/c31c132b143a7abccad3a32042d8ed2b.png)](https://files.realpython.com/media/analog_output.6ea6cfee6f56.png)

该电路与上一节中用于测试模拟输入的电路相同，只有一处不同。由于不可能通过引脚 13 使用 PWM，因此用于 LED 的数字输出引脚是引脚 11。

您可以使用试验板组装电路，如下所示:

[![Circuit for analog output on breadboard](../Images/26991f6639b9a0754341ffac69d201cf.png)](https://files.realpython.com/media/analog_output_2.f8d946a95317.png)
...
[![PWM output on oscilloscope](../Images/eb44bd00fbded896232394b7cefcba6a.png)](https://files.realpython.com/media/analog_output.ba983178383a.gif)
