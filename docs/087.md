...
[![Image of buildings used in Python Pillow tutorial](../Images/1298e78dcf908e31fba73e77a882c454.png)](https://files.realpython.com/media/buildings-1.9786ca5e657d.jpg)
...
[![A crop operation showing the dimensions taken from the origin](../Images/9a4c10b26cd99b6c91cf6aa1dfa445dd.png)](https://files.realpython.com/media/pillow_coordinate_crop2.15af40c34f15.png)

在上面的代码中，`.crop()`返回的新图像的大小为`400x850`像素。裁剪后的图像仅显示原始图片中的一个建筑物:

[![Cropped image in Python Pillow tutorial](../Images/8a2aeebd2dbe38ab37b81400d164d3ac.png)](https://files.realpython.com/media/buildings-2.54ff5556683e.jpg)
...
[![Resized image in Python Pillow tutorial](../Images/1136675b52f7a30ab9fa7c2963ff263c.png)](https://files.realpython.com/media/buildings-3.8aaa8fee17fb.jpg)
...
[![Flipped image in Python Pillow tutorial](../Images/22328bc17f7372f21f174b7fa66cf418.png)](https://files.realpython.com/media/buildings-4.d054549cd56b.jpg)
...
[![Rotated image in Python Pillow tutorial](../Images/711ffda2dbe42e4be93c5d9e14460523.png)](https://files.realpython.com/media/buildings-5.cc8ddfed27ea.jpg)
...
[![Rotated image with expand parameter in Python Pillow tutorial](../Images/490d6d38d72436203e17589f8be5db6d.png)](https://files.realpython.com/media/buildings-6.cef4d68b9ba3.jpg)
...
[![Strawberry image for Python Pillow tutorial](../Images/c049328e86cba129649964c6309a985d.png)](https://files.realpython.com/media/strawberry-1.438a9555d0c2.jpg)
...
[![Strawberry image in grayscale for Python Pillow tutorial](../Images/75b7c35451259af7b6aad81795f4c7ca.png)](https://files.realpython.com/media/strawberry-2.b692fca6e1fe.jpg)
...
[![Strawberry image separate channels for Python Pillow tutorial](../Images/cddef69f4896ce430785d1cbf51f0a96.png)](https://files.realpython.com/media/strawberry-3.fdd949f3db98.jpg)

红色图像在代表草莓的像素中包含强信号，因为这些像素大部分是红色的。绿色和蓝色通道将这些像素显示为深色，因为它们的值很小。例外的是那些代表草莓表面光反射的像素，因为这些像素几乎是白色的。

<button class="btn w-100" data-toggle="collapse" data-target="#collapsebdecac" aria-expanded="false" aria-controls="collapsebdecac" markdown="1">创建本教程中显示的并排显示 显示/隐藏</button>
...
[![Convolution kernel](../Images/2c0a7a2f2e9be8c1cfd62c74101ebdca.png)](https://files.realpython.com/media/kernel-1.3600b296fff0.png)

您可以考虑一个简单的图像来理解使用内核的卷积过程。图像大小为`30x30`像素，包含一条垂直线和一个点。线条宽 4 个像素，点由一个`4x4`像素方块组成。下图被放大以供显示:

[![Image to demonstrate convolution kernel](../Images/69f24b745815aace0c59fe48c35ffd88.png)](https://files.realpython.com/media/kernel-demo-orig.80786662b59d.jpg)

您可以将内核放在图像上的任何位置，并使用内核中央单元的位置作为参考。下图显示了图像的左上部分:

[![Kernel convolution diagram](../Images/08fdf2ef7a764fe64762ec23e5df5dea.png)](https://files.realpython.com/media/kernel-convolution-diagram.75ac0d309cf6.png)
...
[![Convolution kernel demo with Python Pillow](../Images/4fdd19bd0da628ba11bdcbd6f65809d8.png)](https://files.realpython.com/media/kernel-demo-tiled.2ee004251df4.jpg)
...
[![Image showing blur in Python Pillow](../Images/4563aaa7c5329b454b14135143094bc4.png)](https://files.realpython.com/media/blur-comparison-1.41349dbb4d21.jpg)
...
[![Image showing blur in Python Pillow](../Images/63f7ab4527a29f76309c6c56bd2c857e.png)](https://files.realpython.com/media/blur-comparison-2.8f9912f06c28.jpg)
...
[![Image showing sharpening in Python Pillow](../Images/1a0cd36bc8c25032f254e6f524fbf479.png)](https://files.realpython.com/media/sharpen.58594c98d960.jpg)
...
[![Image showing sharpening in Python Pillow](../Images/5d9edc91f71cf4d3f8b57f6ae7b6ea59.png)](https://files.realpython.com/media/smooth_1.bd93e116a6d5.jpg)
...
[![Edge detection in Python Pillow](../Images/34eb0f36df9af571938a14cfea6fc196.png)](https://files.realpython.com/media/edges.9f21fd9a6314.jpg)
...
[![Edge detection in Python Pillow](../Images/193540aa386288e15ec7b376e534e1bd.png)](https://files.realpython.com/media/edges-comparison.236023dafb8b.jpg)
...
[![Edge enhance in Python Pillow](../Images/ecf1d3bb13b10388e895abb57b5c3a37.png)](https://files.realpython.com/media/edge-enhance.e4a42ad3badb.jpg)
...
[![Image emboss in Python Pillow](../Images/86e312a21f314a01753c700064997abc.png)](https://files.realpython.com/media/emboss.c6f777d2aa48.jpg)
...
[![Cat image for use in Python Pillow tutorial](../Images/83669a673fe732ebb23243d45384d88b.png)](https://files.realpython.com/media/cat.8ce1dab25b77.jpg) [![Monastery courtyard image for use in Python Pillow tutorial](../Images/908299cd4768d435546dd5060c613463.png)](https://files.realpython.com/media/monastery.2bbf243677a0.jpg)
...
[![Cropped cat image](../Images/ee4792188173295db4ad6078faf1525e.png)](https://files.realpython.com/media/cat_1.0ad3b85b3bca.jpg)
...
[![Thresholding in Python Pillow](../Images/ef576c1fc8fb54fbb91e76440b16e423.png)](https://files.realpython.com/media/cat_2.55ea108e25c1.jpg)
...
[![Color channels for cat image](../Images/dc7e42defc53d21e9a050d7d73a4a368.png)](https://files.realpython.com/media/cat_3.292653f95a87.jpg)
...
[![Improved thresholding for cat image in Python Pillow tutorial](../Images/d8ed109aef283c4d11e721ac63dcdc78.png)](https://files.realpython.com/media/cat_4.00e679b85d99.jpg)
...
[![Sample image to demonstrate erosion and dilation in Python Pillow](../Images/b6533183b2f67ab343334f2063804811.png)](https://files.realpython.com/media/dot_and_hole.7d97ef4056d0.jpg)
...
[![Erosion in Python Pillow](../Images/bf8c12faf227b1a0de4e5e9283ae1713.png)](https://files.realpython.com/media/erosion_1.b3c47d6c392f.jpg)
...
[![Dilation in Python Pillow](../Images/bd8ca9554efe1c1bd4c65b7dc129a613.png)](https://files.realpython.com/media/dilation_1.9d05f5743968.jpg)
...
[![Erosion in Python Pillow](../Images/ad85b43e0a8985d4514241e4a4e42253.png)](https://files.realpython.com/media/erosion_2.9c150c013cf2.jpg)

圆点消失了，洞比原来的图像要大。第二个`for`循环执行十次扩张循环，将孔恢复到其原始尺寸:

[![Dilation in Python Pillow](../Images/56575de650bc484f07eaa3cf37af22c1.png)](https://files.realpython.com/media/dilation_2.971cb8e1b28c.jpg)
...
[![Erosion and dilation after thresholding](../Images/53d88004c725a0a053c74c9a302b3f83.png)](https://files.realpython.com/media/cat_5.3d440b4b88d2.jpg)
...
[![Erosion and dilation after thresholding](../Images/57cfb0aed6b1a96ff47489a1a686b8ec.png)](https://files.realpython.com/media/cat_6.177626a1f24d.jpg)
...
[![Mask for image segmentation in Python Pillow](../Images/03c836fe27968404d90b82959d830100.png)](https://files.realpython.com/media/cat_7.8272aeccdbb9.jpg)
...
[![Mask for image segmentation in Python Pillow](../Images/a5e8f5ca8d2fefb4aecdbb4d98ae8fb2.png)](https://files.realpython.com/media/cat_mask.24785c3c5875.jpg)
...
[![Segmented image of cat in Python Pillow](../Images/18bcb6196200e42f038cb739abfea23c.png)](https://files.realpython.com/media/cat_segmented.bd613e3f360d.jpg)
...
[![Segmented image of cat superimposed on monastery image](../Images/3d40f895f67e8c89b59d136c896d21b3.png)](https://files.realpython.com/media/cat_monastery.c63df8376d54.jpg)
...
[![Real Python logo](../Images/e7833382f9e8d92015180ac4489f2905.png)](https://files.realpython.com/media/realpython-logo.655da081bdf1.png)
...
[![Outline of Real Python logo in Python Pillow](../Images/8675aa3cded5500172f2c58bc20016c4.png)](https://files.realpython.com/media/rp_outline.4bc2662e0345.jpg)
...
[![Outline of Real Python logo in Python Pillow](../Images/04f7c3fd0437b71ea53e58da2387def1.png)](https://files.realpython.com/media/rp_outline_reverse.d533ba81cf09.jpg)
...
[![Image of cat in monastery with Real Python watermark](../Images/b8a5c16b7a8e95d07fbd082ca36aeddc.png)](https://files.realpython.com/media/cat_monastery_final.885d2150e50b.jpg)
...
[![Spot the difference using Python Pillow](../Images/939e96c11cd3af1f027ed42d7928bb97.png)](https://files.realpython.com/media/spot_the_difference.45817e5a37c0.jpg)
...
[![Spot the difference using Python Pillow](../Images/cfea0f8d5f4d4f19ebe61f00f00e7b8c.png)](https://files.realpython.com/media/spot_the_difference_result.f737d379d3d8.jpg)
...
[![Image generated with NumPy and Python Pillow](../Images/12f1beee9446dbc056aa7fda8544419f.png)](https://files.realpython.com/media/square_gray.deff7490541e.jpg)
...
[![Color image generated with NumPy and Python Pillow](../Images/a4bb3c4f540ab044af50eb934f4c822c.png)](https://files.realpython.com/media/square_color.f9971d72141d.jpg)
...
[![A blue, a green, and a red square merge into a white square centered on a black background](../Images/e3198fab966076e307e8c0d1ff862828.png)](https://files.realpython.com/media/animation_looped.c5622d616183.gif)
