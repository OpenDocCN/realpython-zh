...
[![A diagrammed example of multiple inheritance](../Images/3966d29cc539c35abd845473ed078c79.png)](https://files.realpython.com/media/multiple_inheritance.22fc2c1ac608.png)
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsec6ed16" aria-expanded="false" aria-controls="collapsec6ed16" markdown="1">完整代码示例 显示/隐藏</button>
