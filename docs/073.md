...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse383cfc" aria-expanded="false" aria-controls="collapse383cfc" markdown="1">来源为`adventurelib_game_items.py` 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsec1247e" aria-expanded="false" aria-controls="collapsec1247e" markdown="1">来源为`adventurelib_game_characters.py` 显示/隐藏</button>
...
[![The Ren'Py Launcher](../Images/5ac7dc6ba8ce4e6ca4e0ee004ea8c138.png)](https://files.realpython.com/media/renpy-launcher.fda3bd695f70.png)
...
[![Basic code for Ren'Py](../Images/218b67ac68e7dfaceae4be6dc865c489.png)](https://files.realpython.com/media/renpy-basic.c467db0e49e5.png)
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse6c32d5" aria-expanded="false" aria-controls="collapse6c32d5" markdown="1">来源为`script.rpy` 显示/隐藏</button>
...
当然，这是一部视觉小说，所以伦比有办法处理图像是有道理的。像 Pygame Zero 一样，Ren'Py 要求游戏中使用的所有图像和声音都保存在特定的文件夹中。图像在`game/images/`文件夹中，声音在`game/audio/`文件夹中。在游戏脚本中，你通过文件名来引用它们，没有任何文件扩展名。
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapsea93fc0" aria-expanded="false" aria-controls="collapsea93fc0" markdown="1">来源为`script.rpy` 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse6ca20c" aria-expanded="false" aria-controls="collapse6ca20c" markdown="1">来源为`town.rpy` 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapseed3bb8" aria-expanded="false" aria-controls="collapseed3bb8" markdown="1">来源为`path.rpy` 显示/隐藏</button>
...
<button class="btn w-100" data-toggle="collapse" data-target="#collapse129be0" aria-expanded="false" aria-controls="collapse129be0" markdown="1">来源为`giant.rpy` 显示/隐藏</button>
...
[![The initial blacksmith encounter in Ren'Py](../Images/5b9677f02baab507591d4c37154e5d31.png)](https://files.realpython.com/media/renpy-blacksmith.2c5137b779d4.png)
...
[![Fighting the giant in the Ren'Py game](../Images/71e74937f4c64a286dafd1850202db51.png)](https://files.realpython.com/media/renpy-giant-fight.7fe536c52775.png)
