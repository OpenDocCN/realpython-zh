...
[![PyCharm Testing](../Images/6665f5f2be27a770beb490ac5d230e6a.png)](https://files.realpython.com/media/py_run_test_folder.b0e61b478c81.png)
...
[![Visual Studio Code Step 1](../Images/b8488dc3f7801dca3350d59e8a23b499.png)](https://files.realpython.com/media/vscode-test-capture.dfefa1d20789.PNG)

选择*调试所有单元测试*，VSCode 会提示配置测试框架。点击 cog 选择测试跑步者(`unittest`)和主目录(`.`)。

设置完成后，您将在窗口底部看到测试的状态，并且您可以通过单击这些图标快速访问测试日志并再次运行测试:

[![Visual Studio Code Step 2](../Images/ce3ea11cba75d6d17c9613c71fe83e86.png)](https://files.realpython.com/media/vscode-test-results.951be75c3d3b.PNG)
...
[![Testing Side Effects](../Images/5c3763a8e78f5b1ff52db2e40da354b4.png)](https://files.realpython.com/media/YXhT6fA.d277d5317026.gif)
...
[![Pytest benchmark screenshot](../Images/29abe97566a83ff6c703e0c91372328a.png)](https://files.realpython.com/media/pytest-bench-screen.6d83bffe8e21.png)
